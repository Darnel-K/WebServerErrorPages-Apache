<?php
    $ErrorCodes = array(
        ...
        401 => array('Authentication required!', 'This server could not verify that you are authorized to access the URL "' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'] . '". You either supplied the wrong credentials (e.g., bad password), or your browser doesn\'t understand how to supply the credentials required. In case you are allowed to request the document, please check your user-id and password and try again.'),
        403 => array(),
