...
<body>
    ...
    <div class="swing">
        ...
        <h2 id='Error'>Error 415</h2>
        <section>
            <h3>Just in case you were wondering...</h3>
            <p>The server does not support the media type transmitted in the request.<br><br>If you think this is a server error, please contact the server admin using the link below.</p>
        </section>
